...
const characters: any[] = [
  {
    ...
    role: "大学应届毕业生（待业中）",
    description:
      "本作主人公。茨木大学计算机系毕业，曾是众人眼中的“优等生”，毕业后却在经济下行、就业寒潮和内卷加剧等多重打击下，求职路上接连碰壁，只能暂时宅在家中成为一名「社畜候补」。性格认真踏实，为人冷静可靠，拥有细腻的情感与强烈的责任感。",
  ...
  },
  {
    ...
    role: "大学应届毕业生（待业中）",
    description:
      "茨木大学工商管理系毕业，男主的青梅竹马（？）兼合租室友，从小一起长大。曾经是个教科书级的富二代。天性散漫，做事全凭一时兴起。平时吊儿郎当，却意外了解不少旁门左道，一开口就是金句频出，擅长用嘴把人绕得团团转，堪称画饼届鬼才。",
  ...
  },
  {
    ...
    role: "UI/UX设计师（实习生）",
    description:
      "茨木大学视觉设计系大二在校生，是个绘画天才。平时话很少，内心细腻。对色彩和美感敏锐，有强烈的追求，非常注重细节。性格不张扬却意外地有主见，稍微有点傲娇但又莫名地容易害羞。",
